...
import { LoadingSpinner } from "./subcomponents/SideContent";
            ...
            <div className="min-h-[92vh] w-full bg-red-500 rounded-3xl p-5 border-4 border-yellow-400">
                <div className="flex items-center justify-evenly">
                    {steps.map((step, index) => (
                      <motion.h1
                      key={index}
                      className={`relative z-[9] font-[Kajiro] bg-red-600 text-white px-6 rounded-2xl text-[4vw] font-thin group overflow-hidden after:-z-[1]
